...
public class ResultArray implements com.jsoniter.spi.Encoder {
public void encode(java.lang.Object obj, com.jsoniter.output.JsonStream stream) throws java.io.IOException {
if (obj == null) { stream.writeNull(); return; }
stream.writeRaw("{\"result\":", 10);
encode_((ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.ResultArray)obj, stream);
stream.write((byte)'}');
}
public static void encode_(ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.ResultArray obj, com.jsoniter.output.JsonStream stream) throws java.io.IOException {
