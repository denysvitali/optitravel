...
public class Result implements com.jsoniter.spi.Decoder {
...
if (nextToken != '"') {
if (nextToken == '}') {
return (existingObj == null ? new ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result() : (ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result)existingObj);
} else {
nextToken = com.jsoniter.CodegenAccess.nextToken(iter);
if (nextToken == '}') {
return (existingObj == null ? new ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result() : (ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result)existingObj);
...
ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result obj = (existingObj == null ? new ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result() : (ch.supsi.dti.i2b.shrug.optitravel.api.GTFS_rs.api.Result)existingObj);
obj.result = _result_;
obj.meta = _meta_;
return obj;
