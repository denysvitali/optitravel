...
public class AStar {
    ...
    void initializationDemo(){
        ...
        assertEquals("S", route.get(0).toString());
        assertEquals("C", route.get(1).toString());
        assertEquals("L", route.get(2).toString());
        assertEquals("I", route.get(3).toString());
        assertEquals("J", route.get(4).toString());
        assertEquals("K", route.get(5).toString());
        assertEquals("E", route.get(6).toString());
