...
public class PlacesAutocompletionService {
    ...
    public static List<Prediction> autocomplete(String s) {
    ...
    public static void autocompleteAsync(String s, Callback<List<Prediction>> cb) {
        Runnable r = ()->{
            cb.exec(autocomplete(s));
        };
        Thread t = new Thread(r);
        t.start();
    }

    private static List<Prediction> parseResponse(Response response) {
